...
const LANG = {
  tr: {
    ...
    'animcursor':'Animasyonlu','animcursor_title':'Animasyonlu İmleç','animcursor_desc':'Her durum için bir .ANI dosyası seç. Animasyon atanan durumda Roblox\u2019un sabit imleci gizlenir, yerine native animasyonlu imleç gösterilir. Kaldırılırsa statik imleç geri döner. Not: otomatik durum tespiti bazı oyunlarda ara sıra yanılabilir.','animcursor_none':'Atanmadı — gerçek statik imleç kullanılıyor','animcursor_applied':'Animasyonlu imleç uygulandı ✓','animcursor_removed':'Animasyon kaldırıldı, statik imleç geri döndü ✓',
    ...
    'update_title':'Güncellemeler','update_desc':'Açılışta GitHub\'a tek bir sürüm sorusu gönderir; yeni sürüm varsa haber verir. Güncellemek için Releases sayfasını açar.',
  ...
  en: {
    ...
    'animcursor':'Animated','animcursor_title':'Animated Cursor','animcursor_desc':'Pick a .ANI file for each state. When a state has an animation assigned, Roblox\u2019s static cursor for that state is hidden and replaced by the native animated overlay. Removing it restores the real static cursor. Note: automatic state detection may occasionally misjudge in some games.','animcursor_none':'Not assigned — using the real static cursor','animcursor_applied':'Animated cursor applied ✓','animcursor_removed':'Animation removed, static cursor restored ✓',
    ...
    'update_title':'Updates','update_desc':'Sends a single version query to GitHub on launch and tells you if a new version exists. Opens the Releases page when an update is available.',
