...
const LANG = {
  tr: {
    ...
    'my_cursors':'İmleçlerim','my_cursors_sub':'Yeni bir görsel seçmek için tıkla — önceki seçimlerini Geçmiş sekmesinde bulabilirsin',
    ...
    'animcursor':'Animasyonlu','animcursor_title':'Premium Animasyonlu İmleç (Beta)','animcursor_desc':'🧪 Beta özellik: otomatik durum tespiti bazı oyunlarda ara sıra yanılabilir. Her durum için bir .ANI dosyası seç. Animasyon atanan durumda Roblox\u2019un sabit imleci gizlenir, yerine native animasyonlu imleç gösterilir. Kaldırılırsa statik imleç geri döner.','animcursor_none':'Atanmadı — gerçek statik imleç kullanılıyor','animcursor_applied':'Animasyonlu imleç uygulandı ✓','animcursor_removed':'Animasyon kaldırıldı, statik imleç geri döndü ✓',
    'context_preview':'🖼️ Bağlamda Önizle','context_preview_title':'Bağlamda Önizleme','context_preview_help':'Cursoru gerçek piksel boyutunda, oyun içi bir sahne üzerinde test et.',
  ...
  en: {
    ...
    'my_cursors':'My Cursors','my_cursors_sub':'Click to choose a new image — you can find previous selections in History',
