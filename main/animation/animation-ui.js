...
// Gerçek değer her panel açılışında animCursorGetToggle() ile ana süreçten
// (kalıcı config.json) okunur; buradaki false sadece ilk çizimden önceki
// an için varsayılan (yeni kurulumda animasyon kapalı başlar).
